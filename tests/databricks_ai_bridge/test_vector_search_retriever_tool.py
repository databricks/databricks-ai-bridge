...
@pytest.mark.parametrize("embedding_endpoint,index_details,resources", [
    (
        None,
    ...
    (
        ...
        make_mock_index_details(True, {"embedding_model_endpoint_name": "embedding_endpoint_2"}),
        [
            DatabricksVectorSearchIndex(index_name),

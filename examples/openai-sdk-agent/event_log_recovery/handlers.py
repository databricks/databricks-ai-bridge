"""MLflow handlers for event-log recovery."""
...
# the server appends prior durable events as recovery prose and rotates to a
# fresh agent session. An override can delegate to that behavior and modify it:
#

...
[LangGraph](src/databricks_mason/templates/agent-langgraph/runtime/adapter.py) and
[OpenAI Agents](src/databricks_mason/templates/agent-openai/runtime/adapter.py) adapters show how to

...
includes it inside every durable invocation's `input`; each turn gets a separate invocation UUID.
The router cookie is independent and may still provide sticky replica routing.

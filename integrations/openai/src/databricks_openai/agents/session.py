...
class LakebaseSession(Session):
    """
    OpenAI Agents SDK Session implementation using Lakebase for persistent storage.
    
    This class implements the Session protocol for conversation memory,
    ...
    Session Protocol: https://openai.github.io/openai-agents-python/ref/memory/session/#agents.memory.session.Session
...
```
    ...
    def _ensure_tables(self) -> None:
        ...
        sessions_sql = self.CREATE_SESSIONS_TABLE_SQL.format(

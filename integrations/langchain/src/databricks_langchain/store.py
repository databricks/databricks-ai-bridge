        ...
        **pool_kwargs: Any,
        ...
        Args:
            ...
            embedding_endpoint: Name of the Databricks Model Serving endpoint for embeddings
                (e.g., "databricks-bge-large-en"). If provided, enables semantic search.
            embedding_dims: Dimension of the embedding vectors (e.g., 1024 for bge-large-en,
            ...
            embedding_fields: List of JSON paths to vectorize. Defaults to ["$"] which
                vectorizes the entire JSON value. Use ["text"] if memories are {"text": "..."}.

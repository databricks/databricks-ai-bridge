...
class VectorSearchRetrieverTool(BaseTool, VectorSearchRetrieverToolMixin):
    ...
    **Note**: Any additional keyword arguments passed to the constructor will be passed along to
    `databricks.ai_search.client.VectorSearchIndex.similarity_search` when executing the tool. `See
    documentation <https://api-docs.databricks.com/python/vector-search/databricks.ai_search.html#databricks.ai_search.index.VectorSearchIndex.similarity_search>`_

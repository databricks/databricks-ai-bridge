"""CLI-level unit tests for `agentbricks memory` entries + stores commands.

Backfills coverage for the memory command handlers/render paths in
src/databricks_agentbricks/cli/memory.py using a fake low-level client.
"""
...
from databricks_agentbricks.cli.memory import entries, stores

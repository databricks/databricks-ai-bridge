...
| `--allow-user-scope-update` | flag | - | no | Allow Agent Bricks to add missing user API scopes to an existing App for declarative user auth. Once added, later deploys do not need this flag. |

"""Contracts shared by Agent Bricks Runtime, stores, and agent applications.
...
if TYPE_CHECKING:
    from databricks_agentbricks.runtime.auth import RequestAuthContext
...
class InvocationStatus(str, Enum):
    """Lifecycle states stored by Agent Bricks Runtime."""

...
from databricks_agentbricks.runtime.session_store_client import Session as _StoreSession
from databricks_agentbricks.runtime.session_store_client import SessionStoreClient
    ...
    def _resolve(self) -> _StoreSession:
        ...
        try:
            ...
            self._session = self._client.create_session(
                ...
                metadata={"client": "agentbricks-openai-agent"},
            )
        return self._session

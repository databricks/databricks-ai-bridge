...
class LakebasePool(_LakebaseBase):
    ...
    def __init__(
        ...
        **pool_kwargs: dict[str, Any],
        ...
        self._pool: ConnectionPool[psycopg.Connection[DictRow]] = ConnectionPool(  # type: ignore[assignment]
...
class AsyncLakebasePool(_LakebaseBase):
    ...
    def __init__(
        ...
        **pool_kwargs: object,
        ...
        self._pool: AsyncConnectionPool[psycopg.AsyncConnection[DictRow]] = AsyncConnectionPool(  # type: ignore[assignment]
            conninfo=self._conninfo(),
            kwargs=default_kwargs,
            min_size=min_size,  # type: ignore[invalid-argument-type]
            max_size=max_size,  # type: ignore[invalid-argument-type]
